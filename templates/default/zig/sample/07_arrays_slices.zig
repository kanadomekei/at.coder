...
pub fn main() !void {
    ...
    var mutable_slice = mutable_array[2..6];
    ...
    const found_index = find_element(search_array[..], target_value);
    ...
    // 配列の最大値・最小値
    const max_value = find_max_value(search_array[..]);
    const min_value = find_min_value(search_array[..]);
